    ...
    */
    RGraph.Pie.prototype.Draw = function ()
    {
        ...
        */
        ...
        /**
        * This bit of code converts chart.exploded from an integer to an array
        * that consists of that value, repeated n times, where n is equal to
        * the number of segments that you have
        */
        var explosion = this.Get('chart.exploded');
        if (typeof(explosion) == 'number') {
            this.Set('chart.exploded', RGraph.array_pad([], this.data.length, explosion));
        }
