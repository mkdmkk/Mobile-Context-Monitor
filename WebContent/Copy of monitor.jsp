...
<script type="text/javascript">
	...
	function getContext() {
		...
		httpRequest.open('GET', "ContextRetriever", true);
		httpRequest.send();
	}
	/************************************************************/
	var sleepTime = 10;
...
<body class=" claro background-gray" style="margin-top: 0px">
	<div dojoType="dijit.MenuBar">
		<div dojoType="dijit.MenuBarItem"
			onclick="javascript:moveTo('index.jsp')">Home</div>
		<div dojoType="dijit.PopupMenuBarItem">
			<span>Monitor</span>
			<div dojoType="dijit.Menu">
				<div dojoType="dijit.MenuItem"
					onclick="javascript:moveTo('monitor.jsp')">Member Monitor</div>
				<div dojoType="dijit.MenuItem"
					onclick="javascript:moveTo('monitor.jsp')">Group Monitor</div>
			</div>
		</div>
		<div dojoType="dijit.MenuBarItem"
			onclick="javascript:moveTo('board.jsp')">Board</div>
		<div dojoType="dijit.MenuBarItem"
			onclick="javascript:moveTo('setting.jsp')">Support</div>
		<div dojoType="dijit.MenuBarItem"
			onclick="javascript:moveTo('setting.jsp')">Setting</div>
		<div dojoType="dijit.PopupMenuBarItem">
			<span>Account</span>
			<div dojoType="dijit.Menu">
